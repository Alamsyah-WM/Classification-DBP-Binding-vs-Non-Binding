...
- [Cara Akses Notebook](#cara-akses-notebook)
- [Kontak](#kontak)
...
- `main` - Branch utama berisi README dan dokumentasi umum
...
2. Pilih branch yang ingin dilihat (contoh: `Week-1`)
3. Buka file notebook (.ipynb) yang tersedia
